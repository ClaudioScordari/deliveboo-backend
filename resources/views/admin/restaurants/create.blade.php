        ...
        <div class="container-form card bg-light m-auto w-50 px-5 py-4">
            ...
            <form action="{{ route('admin.restaurants.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 form-group">
                    ...
                    <input class="form-control @error('user_name') is-invalid @enderror" value="{{ old('user_name') }}" maxlength="255"
                        id="user_name" name="user_name" type="text" placeholder="Nome proprietario..." required>
