    ...
    <body class="d-flex">
        ...
        <div class="bg-light text-success text-center p-3" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <!-- ricorda di mettere gli apici nella rotta <a href="{{ route(guest.restaurants.index) }}" class="list-group-item list-group-item-action bg-light text-success fw-bolder">Ristoranti <i class="fa-solid fa-utensils"></i></a>-->
